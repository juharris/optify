...
const { OptionsProvider, GetOptionsPreferences } = await import("../dist/index.js");

const configurableConfigsPath = path.join(__dirname, "../../../tests/test_suites/configurable_values/configs");
...
const featureTrials = [
	...
	["simple", "complex_deep_merge", "complex_nested_objects", "complex_wide_structure"],
];

const WARMUP_ITERATIONS = 20;
const ITERATIONS = 5000;

console.log("Benchmarking getAllOptions vs JSON.parse(getAllOptionsJson(...))\n");
