...
class Liquid::Assign < ::Liquid::Tag
  ...
  #
  # source://liquid//lib/liquid/tags/assign.rb#30
  def initialize(tag_name, markup, parse_context); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/assign.rb#47
  def blank?; end

  # Returns the value of attribute from.
  #
  # source://liquid//lib/liquid/tags/assign.rb#28
  def from; end

  # source://liquid//lib/liquid/tags/assign.rb#40
  ...
  # source://liquid//lib/liquid/tags/assign.rb#53
...
# source://liquid//lib/liquid/tags/assign.rb#73
class Liquid::Assign::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/assign.rb#74
  def children; end
end

# source://liquid//lib/liquid/tags/assign.rb#21
...
# source://liquid//lib/liquid/tags/capture.rb#22
class Liquid::Capture < ::Liquid::Block
  # @return [Capture] a new instance of Capture
  #
  # source://liquid//lib/liquid/tags/capture.rb#25
  def initialize(tag_name, markup, options); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/capture.rb#42
  def blank?; end

  # source://liquid//lib/liquid/tags/capture.rb#34
  def render_to_output_buffer(context, output); end
end

# source://liquid//lib/liquid/tags/capture.rb#23
...
class Liquid::Case < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/case.rb#50
  def nodelist; end

  # source://liquid//lib/liquid/tags/case.rb#37
  def parse(tokens); end

  # source://liquid//lib/liquid/tags/case.rb#65
  def render_to_output_buffer(context, output); end

  # source://liquid//lib/liquid/tags/case.rb#54
  def unknown_tag(tag, markup, tokens); end

  private

  # source://liquid//lib/liquid/tags/case.rb#99
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/case.rb#132
  def parse_lax_when(markup, body); end

  # source://liquid//lib/liquid/tags/case.rb#117
  def parse_rigid_when(markup, body); end

  # source://liquid//lib/liquid/tags/case.rb#146
  def record_else_condition(markup); end

  # source://liquid//lib/liquid/tags/case.rb#107
  def record_when_condition(markup); end

  # source://liquid//lib/liquid/tags/case.rb#89
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/case.rb#95
  def strict_parse(markup); end
end

# source://liquid//lib/liquid/tags/case.rb#156
class Liquid::Case::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/case.rb#157
  def children; end
end
...
class Liquid::Condition
  ...
  class << self
    ...
    def parse_expression(parse_context, markup, safe: T.unsafe(nil)); end
  end
end
...
class Liquid::Cycle < ::Liquid::Tag
  ...
  #
  # source://liquid//lib/liquid/tags/cycle.rb#24
  def initialize(tag_name, markup, options); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/cycle.rb#29
  def named?; end

  # source://liquid//lib/liquid/tags/cycle.rb#33
  def render_to_output_buffer(context, output); end
  ...
  # source://liquid//lib/liquid/tags/cycle.rb#98
  def lax_parse(markup); end
  ...
  #
  # source://liquid//lib/liquid/tags/cycle.rb#130
  def maybe_dup_lookup(var); end

  # cycle [name:] expression(, expression)*
  #
  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/cycle.rb#59
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/cycle.rb#94
  def strict_parse(markup); end

  # source://liquid//lib/liquid/tags/cycle.rb#113
...
# source://liquid//lib/liquid/tags/cycle.rb#134
class Liquid::Cycle::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/cycle.rb#135
  def children; end
end
...
Liquid::Cycle::UNNAMED_CYCLE_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/tags/decrement.rb#25
class Liquid::Decrement < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/decrement.rb#33
  def render_to_output_buffer(context, output); end

  # Returns the value of attribute variable_name.
  #
  # source://liquid//lib/liquid/tags/decrement.rb#26
...
# source://liquid//lib/liquid/tags/doc.rb#30
class Liquid::Doc < ::Liquid::Block
  # @return [Doc] a new instance of Doc
  #
  # source://liquid//lib/liquid/tags/doc.rb#33
  def initialize(tag_name, markup, parse_context); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/doc.rb#61
  def blank?; end

  # source://liquid//lib/liquid/tags/doc.rb#65
  def nodelist; end

  # source://liquid//lib/liquid/tags/doc.rb#38
  def parse(tokens); end

  # source://liquid//lib/liquid/tags/doc.rb#57
  def render_to_output_buffer(_context, output); end

  private

  # source://liquid//lib/liquid/tags/doc.rb#71
  def ensure_valid_markup(tag_name, markup, parse_context); end

  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/doc.rb#77
...
class Liquid::Drop
  ...
  #
  # source://liquid//lib/liquid/drop.rb#63
...
class Liquid::Expression
  class << self
    # source://liquid//lib/liquid/expression.rb#57
    def inner_parse(markup, ss, cache); end

    # source://liquid//lib/liquid/expression.rb#35
    def parse(markup, ss = T.unsafe(nil), cache = T.unsafe(nil)); end

    # source://liquid//lib/liquid/expression.rb#74
    def parse_number(markup, ss); end

    # source://liquid//lib/liquid/expression.rb#31
    def safe_parse(parser, ss = T.unsafe(nil), cache = T.unsafe(nil)); end
  end
end
...
class Liquid::For < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/for.rb#118
  def collection_segment(context); end

  # source://liquid//lib/liquid/tags/for.rb#194
  def render_else(context, output); end

  # source://liquid//lib/liquid/tags/for.rb#150
  def render_segment(context, output, segment); end

  # source://liquid//lib/liquid/tags/for.rb#114
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/for.rb#181
  def set_attribute(key, expr, safe: T.unsafe(nil)); end
end

# source://liquid//lib/liquid/tags/for.rb#202
class Liquid::For::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/for.rb#203
  def children; end
end
...
class Liquid::If < ::Liquid::Block
  ...
  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/if.rb#88
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/if.rb#115
  ...
  def parse_expression(markup, safe: T.unsafe(nil)); end

  # source://liquid//lib/liquid/tags/if.rb#73
  def push_block(tag, markup); end

  # source://liquid//lib/liquid/tags/if.rb#69
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/if.rb#108
  def strict_parse(markup); end
end
...
# source://liquid//lib/liquid/tags/if.rb#136
class Liquid::If::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/if.rb#137
  def children; end
end
...
class Liquid::Include < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/include.rb#111
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/include.rb#33
  def parse(_tokens); end

  # @raise [ArgumentError]
  #
  # source://liquid//lib/liquid/tags/include.rb#36
  def render_to_output_buffer(context, output); end

  # source://liquid//lib/liquid/tags/include.rb#87
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/include.rb#107
  def strict_parse(markup); end
  ...
  # source://liquid//lib/liquid/tags/include.rb#84
  def parse_context; end
end

# source://liquid//lib/liquid/tags/include.rb#130
class Liquid::Include::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/include.rb#131
  def children; end
end
...
class Liquid::Increment < ::Liquid::Tag
  ...
  #
  # source://liquid//lib/liquid/tags/increment.rb#28
  def initialize(tag_name, markup, options); end

  # source://liquid//lib/liquid/tags/increment.rb#33
  def render_to_output_buffer(context, output); end

  # Returns the value of attribute variable_name.
  #
  # source://liquid//lib/liquid/tags/increment.rb#26
  def variable_name; end
end
...
class Liquid::ParseContext
  ...
  # source://liquid//lib/liquid/parse_context.rb#72
  def partial=(value); end

  # source://liquid//lib/liquid/parse_context.rb#79
  def partial_options; end

  # source://liquid//lib/liquid/parse_context.rb#53
  def safe_parse_expression(parser); end
...
module Liquid::ParserSwitching
  # source://liquid//lib/liquid/parser_switching.rb#29
  def parse_with_selected_parser(markup); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/parser_switching.rb#44
  def rigid_mode?; end
  ...
  #
  # source://liquid//lib/liquid/parser_switching.rb#13
  def strict_parse_with_error_mode_fallback(markup); end

  private

  # source://liquid//lib/liquid/parser_switching.rb#66
  def markup_context(markup); end

  # source://liquid//lib/liquid/parser_switching.rb#50
  def rigid_parse_with_error_context(markup); end

  # source://liquid//lib/liquid/parser_switching.rb#58
...
class Liquid::Render < ::Liquid::Tag
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/render.rb#41
  def for_loop?; end

  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/render.rb#124
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/render.rb#49
  def render_tag(context, output); end

  # source://liquid//lib/liquid/tags/render.rb#45
  def render_to_output_buffer(context, output); end

  # render (string) (with|for expression)? (as id)? (key: value)*
  #
  # source://liquid//lib/liquid/tags/render.rb#90
  def rigid_parse(markup); end

  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/render.rb#112
  def rigid_template_name(p); end

  # source://liquid//lib/liquid/tags/render.rb#120
  def strict_parse(markup); end
  ...
  class << self
    # source://liquid//lib/liquid/tags/render.rb#32
...
# source://liquid//lib/liquid/tags/render.rb#142
class Liquid::Render::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/render.rb#143
  def children; end
end
...
# source://liquid//lib/liquid/tags/snippet.rb#16
class Liquid::Snippet < ::Liquid::Block
  # @return [Snippet] a new instance of Snippet
  #
  # source://liquid//lib/liquid/tags/snippet.rb#17
  def initialize(tag_name, markup, options); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/snippet.rb#35
  def blank?; end

  # source://liquid//lib/liquid/tags/snippet.rb#28
  def render_to_output_buffer(context, output); end

  private

  # source://liquid//lib/liquid/tags/snippet.rb#41
  def assign_score_of(snippet_drop); end
end

# source://liquid//lib/liquid/snippet_drop.rb#4
class Liquid::SnippetDrop < ::Liquid::Drop
  # @return [SnippetDrop] a new instance of SnippetDrop
  #
  # source://liquid//lib/liquid/snippet_drop.rb#7
  def initialize(body, name, filename); end

  # Returns the value of attribute body.
  #
  # source://liquid//lib/liquid/snippet_drop.rb#5
  def body; end
  ...
  # source://liquid//lib/liquid/snippet_drop.rb#14
  def to_partial; end

  # source://liquid//lib/liquid/snippet_drop.rb#18
  def to_s; end
end
...
module Liquid::StandardFilters
  ...
  # source://liquid//lib/liquid/standardfilters.rb#101
  def h(input); end
...
class Liquid::TableRow < ::Liquid::Block
  ...
  #
  # source://liquid//lib/liquid/tags/table_row.rb#32
  def initialize(tag_name, markup, options); end

  # Returns the value of attribute attributes.
  #
  # source://liquid//lib/liquid/tags/table_row.rb#30
  def attributes; end
  ...
  # source://liquid//lib/liquid/tags/table_row.rb#69
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/table_row.rb#82
  def render_to_output_buffer(context, output); end

  # source://liquid//lib/liquid/tags/table_row.rb#37
  def rigid_parse(markup); end

  # source://liquid//lib/liquid/tags/table_row.rb#65
  def strict_parse(markup); end
  ...
  # source://liquid//lib/liquid/tags/table_row.rb#131
  def to_integer(value); end
end

# source://liquid//lib/liquid/tags/table_row.rb#28
Liquid::TableRow::ALLOWED_ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://liquid//lib/liquid/tags/table_row.rb#123
class Liquid::TableRow::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/table_row.rb#124
  def children; end
end
...
class Liquid::Tag
  ...
  # Returns the value of attribute parse_context.
  #
  # source://liquid//lib/liquid/tag.rb#9
  def options; end
  ...
  # source://liquid//lib/liquid/tag.rb#75
  def parse_expression(markup, safe: T.unsafe(nil)); end
...
# source://liquid//lib/liquid/tags.rb#27
...
class Liquid::Template
  ...
  #
  # source://liquid//lib/liquid/template.rb#90
  ...
  #
  # source://liquid//lib/liquid/template.rb#98
  ...
  # source://liquid//lib/liquid/template.rb#111
  def registers; end
  ...
  #
  # source://liquid//lib/liquid/template.rb#141
  def render(*args); end

  # source://liquid//lib/liquid/template.rb#200
  def render!(*args); end

  # source://liquid//lib/liquid/template.rb#205
  def render_to_output_buffer(context, output); end
  ...
  # source://liquid//lib/liquid/template.rb#211
  def configure_options(options); end

  class << self
    # source://liquid//lib/liquid/template.rb#43
    def default_exception_renderer; end

    # source://liquid//lib/liquid/template.rb#38
    def default_exception_renderer=(renderer); end

    # source://liquid//lib/liquid/template.rb#77
    def default_resource_limits; end

    # source://liquid//lib/liquid/template.rb#34
    def error_mode; end
    ...
    # source://liquid//lib/liquid/template.rb#47
    ...
    #
    # source://liquid//lib/liquid/template.rb#84
    def parse(source, options = T.unsafe(nil)); end
    ...
    # source://liquid//lib/liquid/template.rb#60
    def register_tag(name, klass); end

    # source://liquid//lib/liquid/template.rb#56
    def tags; end
...
module Liquid::Utils
  class << self
    # source://liquid//lib/liquid/utils.rb#132
    def array_inspect(arr, seen = T.unsafe(nil)); end

    # source://liquid//lib/liquid/utils.rb#158
    def hash_inspect(hash, seen = T.unsafe(nil)); end

    # source://liquid//lib/liquid/utils.rb#114
    def inspect(obj, seen = T.unsafe(nil)); end

    # source://liquid//lib/liquid/utils.rb#8
    def slice_collection(collection, from, to); end

    # source://liquid//lib/liquid/utils.rb#16
    def slice_collection_using_each(collection, from, to); end

    # source://liquid//lib/liquid/utils.rb#68
    def to_date(obj); end

    # source://liquid//lib/liquid/utils.rb#41
    def to_integer(num); end

    # source://liquid//lib/liquid/utils.rb#88
    def to_liquid_value(obj); end

    # source://liquid//lib/liquid/utils.rb#51
    def to_number(obj); end

    # source://liquid//lib/liquid/utils.rb#96
    def to_s(obj, seen = T.unsafe(nil)); end
  end
end

# source://liquid//lib/liquid/utils.rb#5
Liquid::Utils::DECIMAL_REGEX = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/utils.rb#189
...
# source://liquid//lib/liquid/utils.rb#6
Liquid::Utils::UNIX_TIMESTAMP_REGEX = T.let(T.unsafe(nil), Regexp)
...
class Liquid::Variable
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/variable.rb#126
  def disabled?(_context); end

  # source://liquid//lib/liquid/variable.rb#130
  def disabled_tags; end
  ...
  # source://liquid//lib/liquid/variable.rb#88
  ...
  # source://liquid//lib/liquid/variable.rb#107
  def render_to_output_buffer(context, output); end
  ...
  # source://liquid//lib/liquid/variable.rb#177
  def argument(p, positional_arguments, keyword_arguments); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/variable.rb#188
  def end_of_arguments?(p); end

  # source://liquid//lib/liquid/variable.rb#192
  def evaluate_filter_expressions(context, filter_args, filter_kwargs); end

  # source://liquid//lib/liquid/variable.rb#136
  def lax_parse_filter_expressions(filter_name, unparsed_args); end
  ...
  #
  # source://liquid//lib/liquid/variable.rb#159
  def rigid_parse_filter_expressions(p); end
end
...
# source://liquid//lib/liquid/variable.rb#204
class Liquid::Variable::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/variable.rb#205
  def children; end
end
