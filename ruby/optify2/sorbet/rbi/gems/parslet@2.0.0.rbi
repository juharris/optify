...
module Parslet
  ...
  class << self
    ...
    # @return [Parslet::Atoms::Re] a parslet atom
    #
    # source://parslet//lib/parslet.rb#171
    def any; end
    ...
    #   dynamic { rand() < 0.5 ? str('a') : str('b') }
    #
    # source://parslet//lib/parslet.rb#202
    def dynamic(&block); end
    ...
    # @return [Parslet::Atoms::Base] the corresponding parslet parser
    #
    # source://parslet//lib/parslet.rb#256
    def exp(str); end
    ...
    # @see Parslet::Atoms::Infix
    #
    # source://parslet//lib/parslet.rb#242
    def infix_expression(element, *operations, &reducer); end
    ...
    # @overload match
    #
    # source://parslet//lib/parslet.rb#147
    def match(str = T.unsafe(nil)); end
    ...
    #   scope { str('a').capture(:a) }
    #
    # source://parslet//lib/parslet.rb#186
    def scope(&block); end
    ...
    # see {Parslet::Transform}
    #
    # source://parslet//lib/parslet.rb#273
    def sequence(symbol); end
    ...
    # see {Parslet::Transform}
    #
    # source://parslet//lib/parslet.rb#287
    def simple(symbol); end
    ...
    # @return [Parslet::Atoms::Str] a parslet atom
    #
    # source://parslet//lib/parslet.rb#159
    def str(str); end
    ...
    #   { :expression => subtree(:exp) }
    #
    # source://parslet//lib/parslet.rb#297
    def subtree(symbol); end
  end
end
...
class Parslet::Atoms::Alternative < ::Parslet::Atoms::Base
  ...
  # source://parslet//lib/parslet/atoms/alternative.rb#49
  def precedence; end
...
class Parslet::Atoms::Lookahead < ::Parslet::Atoms::Base
  ...
  # source://parslet//lib/parslet/atoms/lookahead.rb#46
  def precedence; end
...
class Parslet::Atoms::Repetition < ::Parslet::Atoms::Base
  ...
  # source://parslet//lib/parslet/atoms/repetition.rb#79
  def precedence; end
...
class Parslet::Atoms::Sequence < ::Parslet::Atoms::Base
  ...
  # source://parslet//lib/parslet/atoms/sequence.rb#44
  def precedence; end
...
class Parslet::Expression::Treetop::Parser < ::Parslet::Parser
  # source://parslet//lib/parslet/expression/treetop.rb#8
  def alternatives; end

  # source://parslet//lib/parslet/expression/treetop.rb#25
  def atom; end

  # source://parslet//lib/parslet/expression/treetop.rb#33
  def char_class; end

  # source://parslet//lib/parslet/expression/treetop.rb#41
  def dot; end

  # source://parslet//lib/parslet/expression/treetop.rb#5
  def expression; end

  # source://parslet//lib/parslet/expression/treetop.rb#59
  def integer; end

  # source://parslet//lib/parslet/expression/treetop.rb#16
  def occurrence; end

  # source://parslet//lib/parslet/expression/treetop.rb#54
  def repetition_spec; end

  # source://parslet//lib/parslet/expression/treetop.rb#3
  def root; end

  # source://parslet//lib/parslet/expression/treetop.rb#13
  def simple; end

  # source://parslet//lib/parslet/expression/treetop.rb#64
  def space; end

  # source://parslet//lib/parslet/expression/treetop.rb#65
  def space?; end

  # source://parslet//lib/parslet/expression/treetop.rb#67
  def spaced(str); end

  # source://parslet//lib/parslet/expression/treetop.rb#44
  def string; end
end
...
class Parslet::Slice
  ...
  #
  # source://parslet//lib/parslet/slice.rb#61
  def length; end
  ...
  #
  # source://parslet//lib/parslet/slice.rb#85
  def to_s; end
...
class Parslet::Source
  ...
  #
  # source://parslet//lib/parslet/source.rb#36
