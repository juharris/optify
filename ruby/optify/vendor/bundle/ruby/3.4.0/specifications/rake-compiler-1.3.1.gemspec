# -*- encoding: utf-8 -*-
# stub: rake-compiler 1.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rake-compiler/rake-compiler/issues", "changelog_uri" => "https://github.com/rake-compiler/rake-compiler/blob/-/History.md", "source_code_uri" => "https://github.com/rake-compiler/rake-compiler" } if s.respond_to? :metadata=
  ...
  s.extra_rdoc_files = ["History.md".freeze, "LICENSE.txt".freeze, "README.md".freeze]
