...
class RBI::Arg < ::RBI::Node
  ...
  # source://rbi//lib/rbi/model.rb#873
...
class RBI::Attr < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#333
  ...
  # source://rbi//lib/rbi/model.rb#330
...
class RBI::AttrAccessor < ::RBI::Attr
  ...
  # source://rbi//lib/rbi/model.rb#381
  sig { override.returns(T::Array[::String]) }
  def fully_qualified_names; end
...
class RBI::AttrWriter < ::RBI::Attr
  ...
  # source://rbi//lib/rbi/model.rb#446
  sig { override.returns(::String) }
  def to_s; end
end
...
class RBI::ConflictTree < ::RBI::Tree
  ...
  #
  # source://rbi//lib/rbi/rewriters/merge_trees.rb#599
...
class RBI::Const < ::RBI::NodeWithComments
  ...
  #
  # source://rbi//lib/rbi/model.rb#301
  sig do
    params(
      name: ::String,
      value: ::String,
...
class RBI::File
  ...
  # source://rbi//lib/rbi/model.rb#151
  ...
  # source://rbi//lib/rbi/printer.rb#877
  sig do
    params(
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1236
  ...
  # source://rbi//lib/rbi/printer.rb#883
...
class RBI::Group::Kind
  class << self
    ...
    # source://rbi//lib/rbi/rewriters/group_nodes.rb#111
    def new(*_arg0); end
  end
end
...
# source://rbi//lib/rbi/rewriters/group_nodes.rb#108
...
# source://rbi//lib/rbi/model.rb#883
class RBI::KwArg < ::RBI::Arg
  ...
  # source://rbi//lib/rbi/model.rb#899
  sig { returns(::String) }
  def to_s; end
end
...
class RBI::KwParam < ::RBI::Param
  ...
  # source://rbi//lib/rbi/model.rb#673
  sig { override.returns(::String) }
  def to_s; end
end
...
# Methods and args
#
# source://rbi//lib/rbi/model.rb#454
class RBI::Method < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#531
  sig { params(name: ::String).void }
  def add_kw_param(name); end

  # source://rbi//lib/rbi/model.rb#541
  sig { params(name: ::String).void }
  ...
  # source://rbi//lib/rbi/model.rb#516
  sig { params(name: ::String).void }
  def add_param(name); end

  # source://rbi//lib/rbi/model.rb#526
  sig { params(name: ::String).void }
  ...
  # source://rbi//lib/rbi/model.rb#464
  sig { returns(T::Boolean) }
  ...
  # source://rbi//lib/rbi/model.rb#456
  sig { returns(::String) }
  def name; end

  # source://rbi//lib/rbi/model.rb#459
  ...
  # source://rbi//lib/rbi/model.rb#480
  sig { params(sigs: T::Array[::RBI::Sig]).returns(T::Array[::RBI::Sig]) }
  def sigs=(sigs); end
...
class RBI::Mixin < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#729
  sig { returns(T::Array[::String]) }
  def names; end
end
...
class RBI::Module < ::RBI::Scope
  ...
  # source://rbi//lib/rbi/model.rb#199
  sig { returns(::String) }
  def name; end
end
...
class RBI::Node
  ...
  # source://rbi//lib/rbi/printer.rb#895
  sig do
    params(
      out: T.any(::IO, ::StringIO),
      indent: ::Integer,
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1251
  sig do
    params(
      out: T.any(::IO, ::StringIO),
      indent: ::Integer,
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1257
  ...
  # source://rbi//lib/rbi/printer.rb#901
  sig { params(indent: ::Integer, print_locs: T::Boolean, max_line_length: T.nilable(::Integer)).returns(::String) }
  def string(indent: T.unsafe(nil), print_locs: T.unsafe(nil), max_line_length: T.unsafe(nil)); end
end
...
class RBI::NodeWithComments < ::RBI::Node
  ...
  # source://rbi//lib/rbi/model.rb#111
  sig { returns(T::Array[::String]) }
  def annotations; end
  ...
  # @return [Boolean]
  #
  # source://rbi//lib/rbi/model.rb#100
  sig { returns(T::Boolean) }
  def comments?; end
...
class RBI::OptParam < ::RBI::Param
  ...
  # source://rbi//lib/rbi/model.rb#640
  sig { returns(::String) }
  def value; end
end
...
class RBI::Param < ::RBI::NodeWithComments
  ...
  #
  # source://rbi//lib/rbi/model.rb#606
  ...
  # source://rbi//lib/rbi/model.rb#603
  sig { returns(::String) }
  def name; end

  # source://rbi//lib/rbi/model.rb#614
  sig { override.returns(::String) }
  def to_s; end
end
...
class RBI::Printer < ::RBI::Visitor
  ...
  #
  # source://rbi//lib/rbi/printer.rb#25
  sig do
    params(
  ...
  # source://rbi//lib/rbi/printer.rb#19
  sig { returns(::Integer) }
  ...
  # source://rbi//lib/rbi/printer.rb#13
  def in_visibility_group; end

  # source://rbi//lib/rbi/printer.rb#13
  def in_visibility_group=(_arg0); end

  # source://rbi//lib/rbi/printer.rb#38
  sig { void }
  def indent; end

  # source://rbi//lib/rbi/printer.rb#22
  sig { returns(T.nilable(::Integer)) }
  def max_line_length; end

  # source://rbi//lib/rbi/printer.rb#16
  ...
  #
  # source://rbi//lib/rbi/printer.rb#76
  sig { params(string: ::String).void }
  ...
  #
  # source://rbi//lib/rbi/printer.rb#69
  sig { params(string: T.nilable(::String)).void }
  ...
  # source://rbi//lib/rbi/printer.rb#98
  ...
  # source://rbi//lib/rbi/printer.rb#180
  sig { override.params(node: ::RBI::Class).void }
  def visit_class(node); end

  # source://rbi//lib/rbi/printer.rb#139
  ...
  # source://rbi//lib/rbi/printer.rb#421
  ...
  # source://rbi//lib/rbi/printer.rb#166
  ...
  # source://rbi//lib/rbi/printer.rb#538
  ...
  # source://rbi//lib/rbi/printer.rb#597
  ...
  # source://rbi//lib/rbi/printer.rb#630
...
# source://rbi//lib/rbi/printer.rb#10
...
# source://rbi//lib/rbi/model.rb#821
...
class RBI::RequiresAncestor < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#1262
  sig { override.returns(::String) }
  def to_s; end
end
...
class RBI::RestParam < ::RBI::Param
  ...
  # source://rbi//lib/rbi/model.rb#659
  sig { override.returns(::String) }
  def to_s; end
end
...
class RBI::Rewriters::SortNodes < ::RBI::Visitor
  ...
  # source://rbi//lib/rbi/rewriters/sort_nodes.rb#71
  ...
  # source://rbi//lib/rbi/rewriters/sort_nodes.rb#43
  sig { params(node: ::RBI::Node).returns(::Integer) }
  def node_rank(node); end

  # source://rbi//lib/rbi/rewriters/sort_nodes.rb#104
  sig { params(node: ::RBI::Node).void }
...
# ~~~
#
# source://rbi//lib/rbi/rewriters/merge_trees.rb#622
class RBI::ScopeConflict < ::RBI::Tree
  # @return [ScopeConflict] a new instance of ScopeConflict
  #
  # source://rbi//lib/rbi/rewriters/merge_trees.rb#630
  ...
  # source://rbi//lib/rbi/rewriters/merge_trees.rb#627
  sig { returns(::String) }
  def left_name; end
...
class RBI::Send < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#847
...
class RBI::Sig < ::RBI::NodeWithComments
  ...
  # source://rbi//lib/rbi/model.rb#908
  sig { returns(T::Array[::RBI::SigParam]) }
  def params; end

  # source://rbi//lib/rbi/model.rb#913
...
class RBI::Struct < ::RBI::Scope
  ...
  # source://rbi//lib/rbi/model.rb#287
  sig { override.returns(::String) }
  def fully_qualified_name; end
  ...
  # source://rbi//lib/rbi/model.rb#262
  sig { returns(::String) }
  def name; end
end
...
class RBI::TEnumBlock < ::RBI::Scope
  ...
  # source://rbi//lib/rbi/model.rb#1151
  sig { override.returns(::String) }
  def fully_qualified_name; end
...
class RBI::TStruct < ::RBI::Class
  ...
  #
  # source://rbi//lib/rbi/model.rb#1048
  sig do
    params(
      name: ::String,
      loc: T.nilable(::RBI::Loc),
...
# source://rbi//lib/rbi/model.rb#1078
...
class RBI::Tree < ::RBI::NodeWithComments
  ...
  #
  # source://rbi//lib/rbi/model.rb#125
  sig do
    params(
      loc: T.nilable(::RBI::Loc),
      comments: T.nilable(T::Array[::RBI::Comment]),
  ...
  # @return [Boolean]
  #
  # source://rbi//lib/rbi/model.rb#138
  sig { returns(T::Boolean) }
  def empty?; end
  ...
  # source://rbi//lib/rbi/rewriters/group_nodes.rb#80
  sig { void }
  def group_nodes!; end
  ...
  # source://rbi//lib/rbi/rewriters/nest_singleton_methods.rb#41
  sig { void }
  ...
  # source://rbi//lib/rbi/rewriters/sort_nodes.rb#115
  sig { void }
  def sort_nodes!; end
...
class RBI::Type
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1266
  sig { returns(::String) }
  def rbs_string; end
...
# source://rbi//lib/rbi/model.rb#1205
class RBI::TypeMember < ::RBI::NodeWithComments
  include ::RBI::Indexable

  # @return [TypeMember] a new instance of TypeMember
  #
  # source://rbi//lib/rbi/model.rb#1210
  sig do
    params(
      name: ::String,
      value: ::String,
...
class RBI::TypePrinter
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1117
  sig { params(type: ::RBI::Type::All).void }
  def visit_all(type); end
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1201
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1167
  sig { params(type: ::RBI::Type::Proc).void }
  def visit_proc(type); end
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1147
  sig { params(type: ::RBI::Type::Shape).void }
  def visit_shape(type); end
...
# source://rbi//lib/rbi/rewriters/nest_non_public_members.rb#58
class RBI::VisibilityGroup < ::RBI::Tree
  # @return [VisibilityGroup] a new instance of VisibilityGroup
  #
  # source://rbi//lib/rbi/rewriters/nest_non_public_members.rb#63
